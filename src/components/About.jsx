...
export default function About() {
  return (
    <section className="about-page">
        ...
        <p>A curious, self-motivated, creative individual always looking to grow and learn more.</p>
        </div>
        ...
        <div className="about-background">
          ...
          <p>The past couple years, I've pursued digital illustration, running a very successful eccomerce business through Etsy and other sites. I've worked with individual clients and businesses on special projects to help them achieve their vision. 
          ...
          <p>I'm proud of all I've learned on my own and I'm so excited to work on a team that will push me to grow and become a better developer!</p>
        </div>
